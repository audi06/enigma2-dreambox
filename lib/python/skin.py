...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "CinoGriPLi/skin.xml" or "PLi-FullNightHD/skin.xml" or "PLi-HD/skin.xml"  # SD hardware is no longer supported by the default skin.
